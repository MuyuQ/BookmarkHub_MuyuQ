...
<p align="center">
  ...
  <p align="center">
    A maintained fork of BookmarkHub for syncing bookmarks across browsers.
    <br />
...
This repository is a fork of [dudor/BookmarkHub](https://github.com/dudor/BookmarkHub).

It keeps the original GitHub Gist bookmark sync flow and adds active maintenance for this fork.

BookmarkHub is a browser extension that synchronizes your bookmarks between different browsers.
...
* Support auto sync (interval/event/hybrid)
* Support WebDAV as an alternative storage backend
* Support bookmark import/export
...
Original Author: [dudor](https://github.com/dudor)

Upstream Project: [https://github.com/dudor/BookmarkHub](https://github.com/dudor/BookmarkHub)
